const mechanismItems = [
  ...
  '子代会继承亲代参数，并发生小幅突变。',
  '每个子代会记录亲代、世代和初始祖先谱系。',
  'lineageId 表示初始祖先谱系，繁殖时会持续继承。',
  'branchId 表示显著突变形成的新分支；普通繁殖会继承亲代 branchId，显著突变时会生成新的 branchId。',
  '能量耗尽或年龄过大时，生物死亡。',
];
...
const observationItems = [
  ...
  '调高突变率可以观察性状快速变化。',
  '切换世代、谱系或突变分支着色，可以观察新旧个体、祖先谱系和突变分支的更替。',
  '突变风暴后关注突变分支区域，可以查看是否出现新 branch，以及新分支是否扩张。',
